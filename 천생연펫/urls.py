...
urlpatterns = [
    ...
    url(r'^shiam', include('menu.urls', namespace = 'shiam')),
    url(r'^siva', include('menu.urls', namespace = 'siva')),
    url(r'^tabie', include('menu.urls', namespace = 'tabie')),
]
